...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_Where
    {
        ...
        {
            List<Cohort> ActualCohorts = PracticeData.Where(cohort => cohort.FullTime == true).ToList(); /*FILL IN LINQ EXPRESSION*/
        ...
        {
            List<Cohort> ActualCohorts = PracticeData.Where(cohort => cohort.PrimaryInstructor.FirstName == "Jurnell").ToList(); /*FILL IN LINQ EXPRESSION*/
        ...
        {
            var ActualCohorts = PracticeData.Where(cohort => cohort.JuniorInstructors.Count() == 3).ToList(); /*FILL IN LINQ EXPRESSION*/
