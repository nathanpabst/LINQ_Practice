...
namespace LINQ_Practice
{
         ...
         */
    {
        ...
        {
            var expected = PracticeData.OrderBy(cohort => cohort.Name).ToList(); /*FILL IN LINQ EXPRESSION*/
        ...
        {
            var expected = PracticeData[0].Students.OrderBy(student => student.Birthday).ToList(); /*FILL IN LINQ EXPRESSION*/ //HINT: Cohort1 is PracticeData[0]
        ...
        {
            var expected = PracticeData[0].Students.OrderByDescending(student => student.Birthday.Year).ToList(); /*FILL IN LINQ EXPRESSION*/ //HINT: Cohort1 is PracticeData[0]
        ...
        {
            var expected = PracticeData[2].JuniorInstructors.OrderBy(instructor => instructor.LastName).ToList(); /*FILL IN LINQ EXPRESSION*/
